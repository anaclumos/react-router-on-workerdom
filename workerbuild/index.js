...
_vhead.innerHTML = `<meta charset="UTF-8">
...
_vbody.innerHTML = `<div id="app"></div>`;
...
/* -begin /assets/index.34cbe912.js */
    ...
    if (blockedPopTx) {
      ...
      if (blockers.length) {
        if (nextIndex != null) {
          ...
          warning$2(false, "You are trying to block a POP navigation to a location that was not created by the history library. The block will fail silently in production, but in general you should do all navigation with the history library (instead of using window.history.pushState directly) to avoid this situation.");
        }
      } else {
        applyTx(nextAction);
      }
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + parentPath + '/*">.'));
  ...
  });
  {
    ...
    warning$1(matches == null || matches[matches.length - 1].route.element != null, 'Matched leaf route at location "' + location.pathname + location.search + location.hash + '" does not have an element. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.');
  }
...
function _renderMatches(matches, parentMatches) {
  ...
  return matches.reduceRight((outlet, match, index) => {
    return /* @__PURE__ */ react.exports.createElement(RouteContext.Provider, {
      children: match.route.element || /* @__PURE__ */ react.exports.createElement(Outlet, null),
      value: {
        outlet,
...
const _excluded = ["onClick", "replace", "state", "target", "to"], _excluded2 = ["aria-current", "caseSensitive", "className", "end", "style", "to"];
...
const NavLink = /* @__PURE__ */ react.exports.forwardRef(function NavLinkWithRef(_ref4, ref) {
  let {
...
function QueryNavLink(_a) {
  ...
  let location = useLocation();
  return /* @__PURE__ */ jsx(NavLink, __spreadValues({
    to: to + location.search
  }, props));
}
function Invoices() {
  let invoices2 = getInvoices();
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs("nav", {
      ...
      }), invoices2.filter((invoice) => {
        let filter = searchParams.get("filter");
        if (!filter)
          return true;
        let name = invoice.name.toLowerCase();
        return name.startsWith(filter.toLowerCase());
      }).map((invoice) => /* @__PURE__ */ jsx(QueryNavLink, {
        style: ({
          isActive
        }) => {
          return {
...
function Invoice() {
  ...
  return /* @__PURE__ */ jsxs("main", {
    ...
    children: [/* @__PURE__ */ jsxs("h2", {
      children: ["Total Due: ", invoice.amount]
    }), /* @__PURE__ */ jsxs("p", {
      children: [invoice.name, ": ", invoice.number]
    }), /* @__PURE__ */ jsxs("p", {
      children: ["Due Date: ", invoice.due]
    }), /* @__PURE__ */ jsx("p", {
...
reactDom.exports.render(/* @__PURE__ */ jsx(BrowserRouter, {
  children: /* @__PURE__ */ jsx(Routes, {
    children: /* @__PURE__ */ jsxs(Route, {
      ...
      children: [/* @__PURE__ */ jsx(Route, {
        path: "expenses",
        element: /* @__PURE__ */ jsx(Expenses, {})
      }), /* @__PURE__ */ jsxs(Route, {
        path: "invoices",
        element: /* @__PURE__ */ jsx(Invoices, {}),
        children: [/* @__PURE__ */ jsx(Route, {
          index: true,
